...
namespace ToDo.Core.Services
{
    public class TaskService
    {
        ...
        public TaskService()
        {
            string applicationFolder = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Personal), "ToDo");
            Directory.CreateDirectory(applicationFolder);
            databaseFileName = Path.Combine(applicationFolder, "ToDo.db");
